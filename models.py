...
class XGBoost:
    def __init__(self, feature_names, target_names, objective='reg:squarederror', n_estimators=100, learning_rate=0.1, max_depth=5, verbosity = 2, train_percentage = 0.8):
        ...
        xgb_model = xgb.XGBRegressor(objective=self.objective, n_estimators=self.n_estimators, learning_rate=self.learning_rate, max_depth=self.max_depth, verbosity = self.verbosity)
